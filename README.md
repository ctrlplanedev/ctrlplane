...
We welcome contributions! See **[CONTRIBUTING.md](CONTRIBUTING.md)** for the full guide — covering local setup, architecture, code style, testing, commit conventions, and the PR process.
