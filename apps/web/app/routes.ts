...
export default [
  route("", "routes/protected.tsx", [
    ...
    route(":workspaceSlug", "routes/ws/_layout.tsx", [
      ...
      route("resource-aggregates", "routes/ws/resource-aggregates.tsx"),
      route(
        "resource-aggregates/:aggregateId",
        "routes/ws/resource-aggregates/page.$aggregateId.tsx",
      ),
      ...
      route(
        "relationship-rules/:ruleId/relationships",
        "routes/ws/relationship-rules/page.$ruleId.relationships.tsx",
      ),
