...
export const CreateResourceDialog: React.FC<{
      ...
      <DialogContent>
        <Form {...form}>
          <form onSubmit={onSubmit} className="space-y-3">
            <DialogHeader>
              <DialogTitle>Bootstrap Resource</DialogTitle>
              <DialogDescription>
                Resources are typically created automatically through scanners
                that discover and register new resources in your infrastructure.
                However, you can manually bootstrap a resource if needed.
              </DialogDescription>
            </DialogHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="MyCustomResource" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
