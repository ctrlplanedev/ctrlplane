...
export const ResourceProviderSelectCard: React.FC<{
  setValue: (v: string) => void;
}> = ({ setValue }) => {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Choose a resource provider.</CardTitle>
        <CardDescription>
          Ctrlplane comes with builtin resource providers to help you get
          started.
        </CardDescription>
      </CardHeader>
