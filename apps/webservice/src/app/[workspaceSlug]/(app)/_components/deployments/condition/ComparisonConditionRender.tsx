...
export const ComparisonConditionRender: React.FC<
  DeploymentConditionRenderProps<ComparisonCondition>
> = ({ condition, onChange, className, depth = 0 }) => {
  ...
  const updateCondition = (
    index: number,
    changedCondition: DeploymentCondition,
  ) =>
    onChange({
      ...condition,
  ...
  const addCondition = (changedCondition: DeploymentCondition) =>
    onChange({
      ...condition,
  ...
  const convertToComparison = (index: number) => {
    ...
    const newComparisonCondition: ComparisonCondition = {
      type: DeploymentConditionType.Comparison,
        ...
        <DropdownMenuContent align="start" className="text-muted-foreground">
          <DropdownMenuGroup>
            <DropdownMenuItem
              onClick={() =>
                addCondition({
                  type: DeploymentConditionType.Name,
            ...
            <DropdownMenuItem
              onClick={() =>
                addCondition({
                  type: DeploymentConditionType.Slug,
                  operator: ColumnOperator.Equals,
                  value: "",
                })
              }
            ...
            <DropdownMenuItem
              onClick={() =>
                addCondition({
                  type: DeploymentConditionType.System,
                  operator: ColumnOperator.Equals,
                  value: "",
                })
              }
            ...
            <DropdownMenuItem
              onClick={() =>
                addCondition({
                  type: DeploymentConditionType.Id,
                  operator: ColumnOperator.Equals,
                  value: "",
                })
              }
