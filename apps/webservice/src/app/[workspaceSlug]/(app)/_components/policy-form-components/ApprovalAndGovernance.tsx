  ...
  <div className="space-y-10 p-2">
    <div className="flex flex-col gap-1">
      ...
      <span className="text-sm text-muted-foreground">
        ...
        contributing to compliance, quality assurance, and overall governance of
    ...
    <div className="space-y-4">
      <div className="flex flex-col gap-1">
        ...
        <span className="text-sm text-muted-foreground">
          ...
          successfully be deployed to before triggering a release. For example,
          specifying that all resources in QA must be deployed to before
          releasing to PROD.
        </span>
      </div>
      ...
      <div>
        ...
        >
          <div className="flex items-center space-x-3 space-y-0">
            ...
            <Label>
              All resources in dependent environments must complete successfully
            </Label>
          </div>
...
//   return (
//     <ApprovalAndGovernanceComponent
//       environmentPolicy={environmentPolicy}
//       isLoading={isLoading || updatePolicy.isPending}
//       onUpdate={onUpdate}
//     />
//   );
// };

// type ApprovalAndGovernanceOverrideProps = {
//   isLoading: boolean;
//   environment: SCHEMA.Environment;
//   environmentPolicy?: SCHEMA.EnvironmentPolicy;
// };

// const ApprovalAndGovernanceOverride: React.FC<ApprovalAndGovernanceOverrideProps> = ({
//   isLoading,
//   environment,
//   environmentPolicy,
// }) => {
...
//   const onUpdate = (data: SCHEMA.UpdateEnvironmentPolicy) => environmentPolicy != null ?
//     updatePolicy.mutateAsync({ id: environmentPolicy.id, data })
// };
