    ...
    <div className="container m-auto max-w-xl space-y-6 p-20">
      ...
      <div className="prose prose-invert text-sm text-muted-foreground">
        <p>
          ...
          components that you want to manage through Ctrlplane. Each deployment
          can have multiple releases and be deployed to different environments.
        </p>
        <p>
          Create a deployment to start managing your release process, tracking
          versions across environments, and applying governance policies to your
          release workflow.
        </p>
      </div>
