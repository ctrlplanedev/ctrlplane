 ...
 */
const getResourceRelationships = (resourceId: string) => {
  ...
  return (
    db
      ...
      .innerJoin(
        sourceMetadata,
        eq(sourceResource.id, sourceMetadata.resourceId),
      )
      .innerJoin(
        targetResource,
...
export const GET = request()
  ...
  >(async (_, { params }) => {
    ...
    const relationships = await getResourceRelationships(resource.id);
