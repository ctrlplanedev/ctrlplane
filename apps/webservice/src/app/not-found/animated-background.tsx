...
export function AnimatedBackground() {
  return (
    <>
      ...
      {/* Animated Grid */}
      <div className="absolute inset-0 -z-10 animate-[float_60s_linear_infinite] bg-[linear-gradient(rgba(255,255,255,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.02)_1px,transparent_1px)] bg-[size:100px_100px] [mask-image:radial-gradient(ellipse_50%_50%_at_50%_50%,black_20%,transparent_100%)]" />
      ...
      <div className="pointer-events-none absolute bottom-1/3 right-1/3 h-24 w-24 animate-[pulse_12s_ease-in-out_infinite] rounded-full bg-primary/10 blur-3xl" />
