...
- Docker Image: `docker.io/ctrlplane/job-policy-checker:latest`,
  [Dockerfile](https://github.com/sizzldev/ctrlplane/blob/main/apps/job-policy-checker/Dockerfile)
- [Helm Chart](https://github.com/sizzldev/ctrlchart/blob/main/charts/job-policy-checker)
