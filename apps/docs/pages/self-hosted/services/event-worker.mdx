...
- Docker Image: `docker.io/ctrlplane/event-worker:latest`, [Dockerfile](https://github.com/sizzldev/ctrlplane/blob/main/apps/event-worker/Dockerfile)
- [Helm Chart](https://github.com/sizzldev/ctrlchart/blob/main/charts/event-worker)
