...
To set this up, navigate to [github.com](https://github.com/) and register a new GitHub App.

- Your GitHub account: https://github.com/settings/apps/new
- Your GitHub organization: `https://github.com/organizations/<your-org>/settings/apps/new`
