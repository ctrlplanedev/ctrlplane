...
in the [Ctrlplane repository](https://github.com/sizzldev/ctrlplane/blob/main/deploy/docker-compose.yaml).

Make sure you are in the same directory as `docker-compose.yaml` and start Ctrlplane:
