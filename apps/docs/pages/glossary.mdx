...
various environments and targets.

**Target:** A specific destination or context where actions are
performed during a deployment. This can be infrastructure like an EKS cluster or
a more abstract concept like a custom object.

**Environment:** A logical grouping of targets representing distinct
stages in the software release process (e.g., QA, Staging, Production).
...
**Metadata:** A tag assigned to a target, used for filtering and
organizing.
...
**Target Provider:** An automated process that discovers, registers, and updates
targets by monitoring infrastructure and external systems.
...
**Job Agent:** The integration component responsible for triggering workflows
in external systems.
