...
**Target:** A specific destination or context where actions are performed during
a deployment. This can be infrastructure like an EKS cluster or a more abstract
concept like a custom object.

**Environment:** A logical grouping of targets representing distinct stages in
...
**Metadata:** A tag assigned to a target, used for filtering and organizing.
