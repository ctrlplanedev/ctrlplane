...
func newDBTestWorkspace(t *testing.T, options ...WorkspaceOption) *TestWorkspace {
	...
	ws := workspace.New(ctx, workspaceID,
		...
		workspace.WithStoreOptions(
			store.WithHybridDeploymentVersions(ctx),
			store.WithHybridEnvironments(ctx),
			store.WithHybridDeployments(ctx),
			store.WithHybridSystems(ctx),
			store.WithHybridResourceProviders(ctx),
			store.WithHybridSystemDeployments(ctx),
			store.WithHybridSystemEnvironments(ctx),
			store.WithHybridResources(ctx),
			store.WithHybridJobAgents(ctx),
			store.WithHybridPolicies(ctx),
			store.WithHybridUserApprovalRecords(ctx),
			store.WithHybridDeploymentVariables(ctx),
			store.WithHybridDeploymentVariableValues(ctx),
			store.WithHybridWorkflows(ctx),
			store.WithHybridWorkflowJobTemplates(ctx),
			store.WithHybridWorkflowRuns(ctx),
			store.WithHybridWorkflowJobs(ctx),
			store.WithHybridResourceVariables(ctx),
			store.WithHybridRelationshipRules(ctx),
