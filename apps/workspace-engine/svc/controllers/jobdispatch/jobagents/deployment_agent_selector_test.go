...
// storeGetter adapts *store.Store to the Getter interface used by the selector.
type storeGetter struct {
	store *store.Store
}

func (g *storeGetter) GetJobAgent(id string) (*oapi.JobAgent, bool) {
	return g.store.JobAgents.Get(id)
}

func (g *storeGetter) GetEnvironment(id string) (*oapi.Environment, bool) {
	return g.store.Environments.Get(id)
}

func (g *storeGetter) GetResource(id string) (*oapi.Resource, bool) {
	return g.store.Resources.Get(id)
}
...
func newTestGetter() (*store.Store, Getter) {
	s := newTestStore()
	return s, &storeGetter{store: s}
}
...
func TestSelectAgents_Legacy_AgentExists(t *testing.T) {
	...
	selector := NewDeploymentAgentsSelector(g, deployment, release)
...
func TestSelectAgents_CEL_MixedConditions(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			sel := NewDeploymentAgentsSelector(g, deployment, release)
