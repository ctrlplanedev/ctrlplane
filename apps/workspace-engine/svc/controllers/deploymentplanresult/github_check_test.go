...
func TestAggregate_CheckTitle(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			aggregate{Total: 3, Completed: 1, Errored: 1, Unsupported: 1, Changed: 1, Additions: 7, Deletions: 3},
			"+7 -3 (1 errored)",
		},
		{
			"final with changes shows diff counts",
			aggregate{Total: 3, Completed: 2, Changed: 1, Unchanged: 1, Unsupported: 1, Additions: 12, Deletions: 4},
			"+12 -4",
		},
		{
