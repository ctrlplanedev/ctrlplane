...
func (s *Relations) GetRelatedEntities(
	c *gin.Context,
	workspaceId string,
...
func (s *Relations) getEntityByType(
...
func (s *Relations) GetRelationshipRules(
	c *gin.Context,
	workspaceId string,
	params oapi.GetRelationshipRulesParams,
) {
	ws, err := utils.GetWorkspace(c, workspaceId)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
...
func (s *Relations) GetRelationshipRule(
	c *gin.Context,
	workspaceId string,
