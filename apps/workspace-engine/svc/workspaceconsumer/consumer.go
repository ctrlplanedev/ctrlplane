	...
	manager.Configure(
		...
		manager.WithWorkspaceCreateOptions(
			...
			workspace.WithStoreOptions(
				wsstore.WithHybridDeploymentVersions(bgCtx),
				wsstore.WithHybridEnvironments(bgCtx),
				wsstore.WithHybridDeployments(bgCtx),
				wsstore.WithHybridSystems(bgCtx),
				wsstore.WithHybridResourceProviders(bgCtx),
				wsstore.WithHybridSystemDeployments(bgCtx),
				wsstore.WithHybridSystemEnvironments(bgCtx),
				wsstore.WithHybridResources(bgCtx),
				wsstore.WithHybridJobAgents(bgCtx),
				wsstore.WithHybridPolicies(bgCtx),
				wsstore.WithHybridUserApprovalRecords(bgCtx),
				wsstore.WithHybridDeploymentVariables(bgCtx),
				wsstore.WithHybridDeploymentVariableValues(bgCtx),
				wsstore.WithHybridWorkflows(bgCtx),
				wsstore.WithHybridWorkflowJobTemplates(bgCtx),
				wsstore.WithHybridWorkflowRuns(bgCtx),
				wsstore.WithHybridWorkflowJobs(bgCtx),
