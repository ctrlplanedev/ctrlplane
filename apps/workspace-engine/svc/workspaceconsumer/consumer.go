	...
	manager.Configure(
		...
		manager.WithWorkspaceCreateOptions(
			...
			workspace.WithStoreOptions(
				...
				wsstore.WithDBRelationshipRules(bgCtx),
				wsstore.WithDBPolicies(bgCtx),
				wsstore.WithDBPolicySkips(bgCtx),
				wsstore.WithDBUserApprovalRecords(bgCtx),
				wsstore.WithDBDeploymentVariables(bgCtx),
				wsstore.WithDBDeploymentVariableValues(bgCtx),
				wsstore.WithDBWorkflows(bgCtx),
				wsstore.WithDBWorkflowJobTemplates(bgCtx),
