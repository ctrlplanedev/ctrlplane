...
func (h *defaultHooks) OnMeasurementTaken(
	ctx context.Context,
	verification *oapi.JobVerification,
	metricIndex int,
	measurement *oapi.VerificationMeasurement,
...
func (h *defaultHooks) OnMetricComplete(
	ctx context.Context,
	verification *oapi.JobVerification,
	metricIndex int,
) error {
...
func (h *defaultHooks) OnVerificationStarted(
	ctx context.Context,
	verification *oapi.JobVerification,
) error {
	return nil
...
func (h *defaultHooks) OnVerificationComplete(
	ctx context.Context,
	verification *oapi.JobVerification,
) error {
	return nil
...
func (h *defaultHooks) OnVerificationStopped(
	ctx context.Context,
	verification *oapi.JobVerification,
) error {
	return nil
...
func (c *CompositeHooks) OnVerificationStarted(
	ctx context.Context,
	verification *oapi.JobVerification,
) (e error) {
...
func (c *CompositeHooks) OnMeasurementTaken(
	ctx context.Context,
	verification *oapi.JobVerification,
	metricIndex int,
	measurement *oapi.VerificationMeasurement,
...
func (c *CompositeHooks) OnMetricComplete(
	ctx context.Context,
	verification *oapi.JobVerification,
	metricIndex int,
) (e error) {
...
func (c *CompositeHooks) OnVerificationComplete(
	ctx context.Context,
	verification *oapi.JobVerification,
) (e error) {
	for _, h := range c.hooks {
...
func (c *CompositeHooks) OnVerificationStopped(
	ctx context.Context,
	verification *oapi.JobVerification,
) (e error) {
	for _, h := range c.hooks {
