...
func TestGetReleaseTargets(t *testing.T) {
	...
	targets := getReleaseTargets(ctx, NewStoreGetters(st), version, env)
...
func TestReleaseTargetJobTracker_GetMostRecentSuccess(t *testing.T) {
	...
	tracker2 := NewReleaseTargetJobTracker(ctx, NewStoreGetters(st), env, version, nil)
...
func TestReleaseTargetJobTracker_FiltersByEnvironmentAndDeployment(t *testing.T) {
	...
	tracker1 := NewReleaseTargetJobTracker(ctx, NewStoreGetters(st), env1, version, nil)
	jobs1 := tracker1.Jobs()
	...
	tracker2 := NewReleaseTargetJobTracker(ctx, NewStoreGetters(st), env2, version, nil)
	jobs2 := tracker2.Jobs()
