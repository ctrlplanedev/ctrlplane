...
func TestEmitTicks_MultipleWorkspaces(t *testing.T) {
	...
	workspace.Set("ws-1", workspace.NewTestWorkspace("ws-1"))
	workspace.Set("ws-2", workspace.NewTestWorkspace("ws-2"))
	workspace.Set("ws-3", workspace.NewTestWorkspace("ws-3"))
