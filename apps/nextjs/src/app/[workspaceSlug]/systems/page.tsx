...
export default function SystemsPage({
  ...
  const systemsAll = api.system.list.useQuery(
  ...
  if (systemsAll.isSuccess && systemsAll.data.total === 0)
    return <SystemGettingStarted workspaceId={workspace.data?.id ?? ""} />;
  ...
  return (
    <div className="h-full">
      ...
      {(systems.isLoading || workspace.isLoading) && (
