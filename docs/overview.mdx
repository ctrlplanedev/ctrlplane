...
In short: **Deployments** define _what and how_, **Environments** define _where_, and **Policies** define _when_.
...
Policies are the rules that govern _when_ a version is allowed to deploy:
