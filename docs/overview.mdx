...
```mermaid
flowchart LR
    CI["CI Build"] -->|"1. create version"| CP["Ctrlplane"]
    CP -->|"2. evaluate policies"| CP
    CP -->|"3. dispatch job"| Agent["Job Agent"]
    Agent -->|"4. deploy"| Target["Resource"]
    Target -->|"5. verify"| CP
    CP -->|"6. promote or rollback"| Next["Next Target"]
```
