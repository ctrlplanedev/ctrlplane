...
- [Deployment Versions](./releases-and-jobs.md#versions) - Understand version lifecycle
- [Release Targets](./release-targets.md) - How the deployment matrix works
- [Variables](../advanced/variables.md) - Using variables for configuration
- [CI/CD Integration](../integrations/) - Integrate with your CI system
