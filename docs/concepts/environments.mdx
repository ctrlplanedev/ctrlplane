...
An **Environment** represents a logical deployment stage in your pipeline, 
such as development, staging, or production. Environments use selectors to 
dynamically determine which resources belong to them. From a deployment perspective, 
an environment is additional metadata attached to the resources it selects.
