...
Your CI builds code. Your compute run it. Ctrlplane decides _when_ releases are
...
- **Inconsistent policies**: Some services require approval, some don't—it's
  tribal knowledge
- **Painful multi-region**: Deploying to 10 compute resources means running 10
  pipelines
...
<CardGroup cols={2}>
  ...
  <Card title="Comparisons" icon="scale-balanced" href="./comparisons">
    See how Ctrlplane compares to other tools
  </Card>
