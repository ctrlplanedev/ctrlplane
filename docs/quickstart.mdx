...
---
type: Resource
identifier: tutorial-quickstart-resource-a
kind: KubernetesCluster
name: quickstart-region-a
...
---
type: Resource
identifier: tutorial-quickstart-resource-b
kind: KubernetesCluster
name: quickstart-region-b
version: tutorial/quickstart/v1
metadata:
  tutorial: quickstart
  environment: tutorial
...
Job agents execute your deployments. We'll use a simle test runner, but Ctrlplane
supports Github, Kubernetes jobs, ArgoCD, or custom agents.
