...
export interface components {
  schemas: {
    ...
    WorkflowTemplateVariableConfig:
      | components["schemas"]["WorkflowTemplateVariableConfigString"]
      | components["schemas"]["WorkflowTemplateVariableConfigNumber"]
      | components["schemas"]["WorkflowTemplateVariableConfigBoolean"]
      | components["schemas"]["WorkflowTemplateVariableConfigChoice"]
      | components["schemas"]["WorkflowTemplateVariableConfigResource"]
      | components["schemas"]["WorkflowTemplateVariableConfigEnvironment"]
      | components["schemas"]["WorkflowTemplateVariableConfigDeployment"];
