...
export interface components {
    schemas: {
        ...
        ArgoWorkflowsJobAgentConfig: {
            /** @description Argo Workflows API token. */
            apiKey: string;
            /** @description Kubernetes namespace for workflow execution (defaults to "default" if omitted). */
            namespace?: string;
            /** @description Argo Workflows server address (host[:port] or URL). */
            serverUrl: string;
            /** @description Argo Workflow template. */
            template: string;
        };
