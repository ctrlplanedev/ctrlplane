...
export class DefaultApi extends runtime.BaseAPI {
    ...
    async acknowledgeJobRaw(requestParameters: AcknowledgeJobRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AcknowledgeJob200Response>> {
        ...
        const response = await this.request({
            path: `/v1/job/{jobId}/acknowledge`.replace(`{${"jobId"}}`, encodeURIComponent(String(requestParameters['jobId']))),
            method: 'POST',
     ...
     */
    async getAgentRunningJobRaw(requestParameters: GetAgentRunningJobRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<GetAgentRunningJob200ResponseInner>>> {
        ...
        const response = await this.request({
            path: `/v1/job-agents/{agentId}/jobs/running`.replace(`{${"agentId"}}`, encodeURIComponent(String(requestParameters['agentId']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(GetAgentRunningJob200ResponseInnerFromJSON));
    }

    /**
     * Get a agents running jobs
     */
    async getAgentRunningJob(requestParameters: GetAgentRunningJobRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<GetAgentRunningJob200ResponseInner>> {
        const response = await this.getAgentRunningJobRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async getJobRaw(requestParameters: GetJobRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetJob200Response>> {
        ...
        const response = await this.request({
            path: `/v1/job/{jobId}`.replace(`{${"jobId"}}`, encodeURIComponent(String(requestParameters['jobId']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Update a job
     */
    async updateJobRaw(requestParameters: UpdateJobOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UpdateJob200Response>> {
        if (requestParameters['jobId'] == null) {
            throw new runtime.RequiredError(
                'jobId',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => UpdateJob200ResponseFromJSON(jsonValue));
    }

    /**
     * Update a job
     */
    async updateJob(requestParameters: UpdateJobOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UpdateJob200Response> {
