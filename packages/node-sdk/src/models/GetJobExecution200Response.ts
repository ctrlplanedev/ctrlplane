 ...
 */
export function instanceOfGetJobExecution200Response(
  value: object,
): value is GetJobExecution200Response {
...
export function GetJobExecution200ResponseFromJSON(
  json: any,
): GetJobExecution200Response {
  return GetJobExecution200ResponseFromJSONTyped(json, false);
}

export function GetJobExecution200ResponseFromJSONTyped(
  json: any,
...
export function GetJobExecution200ResponseToJSON(
  value?: GetJobExecution200Response | null,
): any {
  if (value == null) {
    return value;
  }
