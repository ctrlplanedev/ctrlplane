...
ALTER TABLE "release_target_lock_record" ADD CONSTRAINT "release_target_lock_record_locked_by_user_id_fk" FOREIGN KEY ("locked_by") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;