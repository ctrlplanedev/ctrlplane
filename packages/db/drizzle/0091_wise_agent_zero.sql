...
--> statement-breakpoint
ALTER TABLE "computed_policy_target_deployment" ADD CONSTRAINT "computed_policy_target_deployment_policy_target_id_policy_id_fk" FOREIGN KEY ("policy_target_id") REFERENCES "public"."policy"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "computed_policy_target_environment" ADD CONSTRAINT "computed_policy_target_environment_policy_target_id_policy_id_fk" FOREIGN KEY ("policy_target_id") REFERENCES "public"."policy"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "computed_policy_target_resource" ADD CONSTRAINT "computed_policy_target_resource_policy_target_id_policy_id_fk" FOREIGN KEY ("policy_target_id") REFERENCES "public"."policy"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
