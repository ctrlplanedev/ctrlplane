CREATE TABLE "workflow" (
	...
	"job_agents" jsonb DEFAULT '[]' NOT NULL,
...
ALTER TABLE "workflow_job" ADD CONSTRAINT "workflow_job_job_id_job_id_fk" FOREIGN KEY ("job_id") REFERENCES "public"."job"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
